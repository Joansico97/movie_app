...
class _Size {
  ...
  double width(BuildContext context, double value) => fullWidth(context) * value;

  double height(BuildContext context, double value) => fullHeight(context) * value;
  ...
  EdgeInsets horizontal(BuildContext context, double value) => EdgeInsets.symmetric(
        horizontal: fullWidth(context) * value,
      );

  EdgeInsets vertical(BuildContext context, double value) => EdgeInsets.symmetric(
